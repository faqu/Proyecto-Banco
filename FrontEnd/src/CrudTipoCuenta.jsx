    ...
    const handleCreateOrUpdate = async () => {
        try {
            ...
            if (selectedRoleId) {
                ...
                await fetch('http://localhost:32768/api/TipoCuentas${selectedRoleId}', {
                    method: 'PUT',
                    headers: {
                ...
                await fetch('http://localhost:32768/api/TipoCuentas', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
